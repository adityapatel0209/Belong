...
import { Link } from "react-router-dom"; // Use react-router-dom for routing in Vite
import { cn } from "../../../utils/cn"; // Ensure the utility function is available or replace it
...
export const PinContainer = ({
    ...
    return (
        <Link
            ...
            to={href || "/"} // Use 'to' instead of 'href' with react-router-dom
        >
            <div
                style={{
                    perspective: "1000px",
        ...
        >
            <div className=" w-full h-full -mt-7 flex-none  inset-0">
                ...
                >
                    ...
                    ></motion.div>
                    {/* Duplicate motion effects for additional layers */}
                </div>
            </div>
        </motion.div>
    );
