...
const Footer = () => {
    ...
    const footerLinks = {
        "Features": [
            { name: "Mental Health Support", href: "/about" },
            { name: "AI Chat Buddy", href: "/ai" },
            { name: "Educational Resources", href: "/educate" },
    ...
    const socialLinks = [
        {
            name: "GitHub",
            href: "https://github.com/adityapatek",
            icon: (
        ...
        {
            name: "LinkedIn",
            href: "https://linkedin.com/in/adityapatek",
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: "Twitter",
            href: "https://twitter.com/adityapatek",
            icon: (
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    return (
        <footer className="bg-[#f7fced] border-t border-gray-200 dark:border-gray-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {/* Brand Section */}
                    <div className="space-y-4">
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Belong</h2>
                ...
                <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <p className="text-gray-600 dark:text-gray-400 text-sm">
                            © {currentYear} Belong. Created by Aditya Patek
                        </p>
